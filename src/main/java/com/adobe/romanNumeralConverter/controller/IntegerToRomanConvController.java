...
public class IntegerToRomanConvController {
...

	{
		...
		return ResponseEntity.status(HttpStatus.OK).body(integerToRomanConverterService.convertIntegerToRoman(input)); // (integerToRomanConverterService.convertIntegerToRoman(input),
																														// HttpStatus.OK);
	}
}
